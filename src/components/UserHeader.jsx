                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li className="nav-item">
                            <Link
                                ...
                                to="/groups"
                            >
                                <i className="bi bi-collection me-1"></i> My Groups
                            </Link>
                        </li>
                        {userPermissions.canViewUsers && (
                            <li className="nav-item">
                                <Link
                                    className={`nav-link px-3 ${isActive("/manage-users")}`}
                                    to="/manage-users"
                                >
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-2 rounded-3">
                                ...
                                >
                                    ...
                                    {user?.role && (
                                        <span className="badge bg-primary mt-2 text-uppercase" style={{ fontSize: "10px" }}>
                                            {user.role}
                                        </span>
                                    )}
                                </li>
